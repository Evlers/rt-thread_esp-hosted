...
#define IPERF_TRAFFIC_TASK_PRIORITY DFLT_TASK_PRIO
#define IPERF_TRAFFIC_TASK_STACK DFLT_TASK_STACK_SIZE
#define IPERF_REPORT_TASK_NAME "iperf_report"
#define IPERF_REPORT_TASK_PRIORITY DFLT_TASK_PRIO
#define IPERF_REPORT_TASK_STACK DFLT_TASK_STACK_SIZE
...
#define IPERF_SOCKET_ACCEPT_TIMEOUT 10
