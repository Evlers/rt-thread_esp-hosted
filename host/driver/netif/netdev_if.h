 ...
 * @retval none
 */
void netdev_stub_free(netdev_handle_t netdev);
 ...
 */
void * netdev_stub_get_priv(netdev_handle_t netdev);
 ...
 *              on failure: -1
 */
int netdev_stub_register(netdev_handle_t netdev, struct netdev_ops *ops);
 ...
 *              on failure: -1
 */
int netdev_stub_unregister(netdev_handle_t netdev);
 ...
 */
int netdev_stub_rx(netdev_handle_t netdev, struct pbuf *net_buf);
